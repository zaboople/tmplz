...
public class Loader {
   ...
   */
  public static String loadString(java.io.InputStream ios) throws Exception{
    return loadString(ios, 512);
  }
   ...
   */
  public static String loadString(java.io.InputStream ios, int approxlen) throws Exception{
    try {
      InputStreamReader br=new InputStreamReader(ios);
